...
pub struct PassColumns {
    pub(crate) wepp_id: Vec<i32>,
    pub(crate) event: Vec<String>,
    pub(crate) year: Vec<i16>,
    pub(crate) sim_day_index: Vec<i32>,
    pub(crate) julian: Vec<i16>,
    pub(crate) month: Vec<i8>,
    pub(crate) day_of_month: Vec<i8>,
    pub(crate) water_year: Vec<i16>,
    pub(crate) dur: Vec<f64>,
    pub(crate) tcs: Vec<f64>,
    pub(crate) oalpha: Vec<f64>,
    pub(crate) runoff: Vec<f64>,
    pub(crate) runvol: Vec<f64>,
    pub(crate) sbrunf: Vec<f64>,
    pub(crate) sbrunv: Vec<f64>,
    pub(crate) drainq: Vec<f64>,
    pub(crate) drrunv: Vec<f64>,
    pub(crate) peakro: Vec<f64>,
    pub(crate) tdet: Vec<f64>,
    pub(crate) tdep: Vec<f64>,
    pub(crate) sedcon_1: Vec<f64>,
    pub(crate) sedcon_2: Vec<f64>,
    pub(crate) sedcon_3: Vec<f64>,
    pub(crate) sedcon_4: Vec<f64>,
    pub(crate) sedcon_5: Vec<f64>,
    pub(crate) clot: Vec<f64>,
    pub(crate) slot: Vec<f64>,
    pub(crate) saot: Vec<f64>,
    pub(crate) laot: Vec<f64>,
    pub(crate) sdot: Vec<f64>,
    pub(crate) gwbfv: Vec<f64>,
    pub(crate) gwdsv: Vec<f64>,
}
